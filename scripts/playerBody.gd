...
func _process(delta):
	...
	var motion = (Global.buffs_sum(Global.player_data.buffs.agility)+Global.charactersData[Global.charID].agility+25)*direction #Calculate the movement vector using the joystick variables
