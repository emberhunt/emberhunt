...
export var stats = {
	...
	bullet_gradient = Gradient, # a color ramp to interpolate bullet colors based on traveled distance, if this is left as it is, the plain color from above will be used
